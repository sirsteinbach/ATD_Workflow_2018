...
if(($viewPrice=="N")&&($viewGallery=="N")&&($viewCalendar=="N")){
	...
	$_SESSION["Checkpoint"]["m1"]="It seems you haven't viewed any of our galleries, checked our calendar for availability, or even seen our prices! Wouldn't you like to see any of those before continuing?";
	$_SESSION["Checkpoint"]["i2"]="fa-envelope";
	$_SESSION["Checkpoint"]["t2"]="Continue Anyway . . .";
	$_SESSION["Checkpoint"]["m2"]="Sure, no problem... But please don't ask to see our work, or if we're available on your date, or what our prices are, okay? <em>That's what those buttons above are for.</em>";
...
elseif(($viewPrice=="N")&&($viewGallery=="Y")&&($viewCalendar=="Y")){
	...
	$_SESSION["Checkpoint"]["m1"]="You'd be surprised how often couples contact us and ask us what our prices are! You wouldn't want that to be you too, <em>right</em>?";
	$_SESSION["Checkpoint"]["i2"]="fa-picture-o";
	$_SESSION["Checkpoint"]["t2"]="Continue On . . .";
	$_SESSION["Checkpoint"]["m2"]="That's totally cool. You are welcome to contact us for whatever reason. Just remember our prices are available right <em>here on our website</em>.";
	$_SESSION["Checkpoint"]["btn-P"]="Y";
...
elseif(($viewPrice=="Y")&&($viewGallery=="N")&&($viewCalendar=="Y")){
	...
	$_SESSION["Checkpoint"]["m1"]="It seems you haven't visited any of our galleries yet! Would you like to look at our photography galleries before continuing?";
	$_SESSION["Checkpoint"]["i2"]="fa-picture-o";
	$_SESSION["Checkpoint"]["t2"]="Continue Without Viewing . . .";
	$_SESSION["Checkpoint"]["m2"]="Okay, you're in charge here! Just don't forget about our galleries. There's no best way to see what to expect from us!";
...
elseif(($viewPrice=="Y")&&($viewGallery=="Y")&&($viewCalendar=="N")){
	...
	$_SESSION["Checkpoint"]["t2"]="Don't Need Availability . . .";
	$_SESSION["Checkpoint"]["m2"]="Sure, no problem... But please don't ask to see our work, or if we're available, or what our prices are, okay?";
	$_SESSION["Checkpoint"]["btn-P"]="";
	$_SESSION["Checkpoint"]["btn-G"]="";
	$_SESSION["Checkpoint"]["btn-C"]="Y";
	}
elseif(($viewPrice=="Y")&&($viewGallery=="N")&&($viewCalendar=="N")){
	...
	$_SESSION["Checkpoint"]["m1"]="It looks like you haven't viewed any of our galleries or checked our online calendar for availability!</p><p>Would you like to see those before contacting us?";
	$_SESSION["Checkpoint"]["i2"]="fa-envelope";
	$_SESSION["Checkpoint"]["t2"]="That's Fine, Continue . . .";
	$_SESSION["Checkpoint"]["m2"]="Sure, you're welcome to contact us for whatever reason. Just don't ask to see our work or if we're availble now.";
	$_SESSION["Checkpoint"]["btn-P"]="";
	$_SESSION["Checkpoint"]["btn-G"]="Y";
	$_SESSION["Checkpoint"]["btn-C"]="Y";
	}
elseif(($viewPrice=="N")&&($viewGallery=="Y")&&($viewCalendar=="N")){
	...
	$_SESSION["Checkpoint"]["i2"]="fa-envelope";
	$_SESSION["Checkpoint"]["t2"]="Continue Anyway . . .";
	$_SESSION["Checkpoint"]["m2"]="Sure, you're welcome to contact us for whatever reason. Just don't ask to see our work or what our prices are. <em>That's those buttons up above!</em>";
	$_SESSION["Checkpoint"]["btn-P"]="Y";
	$_SESSION["Checkpoint"]["btn-G"]="";
	$_SESSION["Checkpoint"]["btn-C"]="Y";
	}
elseif(($viewPrice=="N")&&($viewGallery=="N")&&($viewCalendar=="Y")){
	...
	$_SESSION["Checkpoint"]["i2"]="fa-envelope";
	$_SESSION["Checkpoint"]["t2"]="Continue Anyway . . .";
	$_SESSION["Checkpoint"]["m2"]="Sure, you're welcome to contact us for whatever reason. Just don't ask to see our work or if we're availble then.";
	$_SESSION["Checkpoint"]["btn-P"]="Y";
	$_SESSION["Checkpoint"]["btn-G"]="Y";
	$_SESSION["Checkpoint"]["btn-C"]="";
	}
