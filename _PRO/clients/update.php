        ...
        <div id="ContactInfo" class="row">
          <div class="panel empty radius panelMargin">
            ...
            <div class="row collapse">
              ...
              <label for="FirstName1" class="prefix radius"><? echo $NameType1 ?> First Name:</label>
              </div>
              <div class="small-6 columns">
                <input type="text" value="<?php echo htmlentities($row_rsUpdate['FirstName1'], ENT_COMPAT, 'UTF-8'); ?>" name="FirstName1" id="FirstName1" required pattern="[a-zA-Z\s]+"><small class="error"><? echo $NameType1 ?> first name is required!</small>
              </div>
            ...
            <div class="row collapse">
              <div class="small-5 columns">
              <label for="LastName1" class="prefix radius"><? echo $NameType1 ?> Last Name:</label>
              </div>
              <div class="small-6 columns">
                <input type="text" value="<?php echo htmlentities($row_rsUpdate['LastName1'], ENT_COMPAT, 'UTF-8'); ?>" name="LastName1" id="LastName1" required pattern="[a-zA-Z\s]+"><small class="error"><? echo $NameType1 ?> last name is required!</small>
              </div>
              <div class="small-1 columns">
                <span class="postfix radius">&nbsp;</span>
              </div>
            ...
            <div class="row collapse">
              <div class="small-5 columns">
              <label for="FirstName2" class="prefix radius"><? echo $NameType2 ?> First Name:</label>
              </div>
              <div class="small-6 columns">
                <input type="text" value="<?php echo htmlentities($row_rsUpdate['FirstName2'], ENT_COMPAT, 'UTF-8'); ?>" name="FirstName2" id="FirstName2" required pattern="[a-zA-Z\s]+"><small class="error"><? echo $NameType2 ?> first name is required!</small>
              </div>
              <div class="small-1 columns">
                <span class="postfix radius">&nbsp;</span>
              </div>
            ...
            <div class="row collapse">
              <div class="small-5 columns">
              <label for="LastName2" class="prefix radius"><? echo $NameType2 ?> Last Name:</label>
              </div>
              <div class="small-6 columns">
                <input type="text" value="<?php echo htmlentities($row_rsUpdate['LastName2'], ENT_COMPAT, 'UTF-8'); ?>" name="LastName2" id="LastName2" required pattern="[a-zA-Z\s]+"><small class="error"><? echo $NameType2 ?> last name is required!</small>
              </div>
              <div class="small-1 columns">
                <span class="postfix radius">&nbsp;</span>
              </div>
        ...
        <div id="PaymentCenter" class="row">
          <div class="panel money radius panelMargin">
            ...
            <div class="row collapse">
              ...
              <div class="small-3 columns">
                <input type="text" name="PackageAmt" id="PackageAmt" value="<? echo $row_rsUpdate['PackageAmt'] ?>" readonly style="cursor:default;">
              </div>
              <div class="small-1 columns">
                <span class="postfix radius">&nbsp;</span>
              </div>
            ...
            <div class="row collapse">
              ...
              <div class="small-3 columns">
               <input type="text" name="TaxRate" id="TaxRate" value="<? echo $row_rsUpdate['TaxRate']?>" readonly style="cursor:default;">
               </div>
              <div class="small-1 columns">
                <span class="postfix radius">%</span>
              </div>
            ...
            <!--Opt1Value-->
            <input type="hidden" id="Opt1Tax" value="<? echo $row_rsUpdate['Opt1Tax']?>">
            <div class="row collapse <?php if($row_rsUpdate['Opt1Value']!=''){echo 'phpshow';}else{echo 'phphide';} ?>">
              ...
              <div class="small-3 columns">
                <input type="text" name="Opt1Amt" id="Opt1Amt" value="<? echo $row_rsUpdate['Opt1Amt']?>" readonly style="cursor:default;">
                </div>
              <div class="small-1 columns">
                <span class="postfix radius">&nbsp;</span>
              </div>
            ...
            <!--Opt2Value-->
            <input type="hidden" id="Opt2Tax" value="<? echo $row_rsUpdate['Opt2Tax']?>">
            <div class="row collapse <?php if($row_rsUpdate['Opt2Value']!=''){echo 'phpshow';}else{echo 'phphide';} ?>">
              ...
              <div class="small-3 columns">
                <input type="text" name="Opt2Amt" id="Opt2Amt" value="<? echo $row_rsUpdate['Opt2Amt'] ?>" readonly style="cursor:default;">
                </div>
              <div class="small-1 columns">
                <span class="postfix radius">&nbsp;</span>
                </div>
            ...
            <!--Opt3Value-->
            <input type="hidden" id="Opt3Tax" value="<? echo $row_rsUpdate['Opt3Tax']?>">
            <div class="row collapse <?php if($row_rsUpdate['Opt3Value']!=''){echo 'phpshow';}else{echo 'phphide';} ?>">
              ...
              <div class="small-3 columns">
                <input type="text" name="Opt3Amt" id="Opt3Amt" value="<? echo $row_rsUpdate['Opt3Amt'] ?>" readonly style="cursor:default;">
                </div>
              <div class="small-1 columns">
                <span class="postfix radius">&nbsp;</span>
                </div>
            ...
            <div class="row collapse">
              ...
              <div class="small-3 columns">
                <input type="text" name="PaidAmt" id="PaidAmt" value="<? echo $row_rsUpdate['PaidAmt'] ?>" readonly style="cursor:default;">
              </div>
              <div class="small-1 columns">
                <span class="postfix radius">&nbsp;</span>
              </div>
      ...
      <div class="medium-6 columns">
        ...
        <div id="PackageOptions" class="row">
          <div class="panel selections radius panelMargin">
            ...
            <!--OnlineGallery-->
            <? if($row_rsUpdate['OnlineGallery']=='1'){ ?>
            <div class="outline">
              <div class="row collapse">
                <div class="small-1 columns">
              ...
              <div class="row collapse">
                ...
                <div class="small-1 small-pull-1 columns">
                  <span class="postfix radius"><?php if($row_rsUpdate['OGstatus']=='1'){ ?><i class="fa fa-lock"></i><? }?></span>
                </div>
              </div>
              <? if($row_rsUpdate['OGnote']!=''){ ?>
              <div class="row">
            ...
            <? } //End OnlineGallery ?>
            <!--DigitalImages-->
            <? if($row_rsUpdate['DigitalImages']=='1'){ ?>
            <div class="row collapse">
              <div class="small-1 columns">
            ...
            <div class="row collapse">
              ...
              <div class="small-1 small-pull-1 columns">
                <span class="postfix radius"><?php if($row_rsUpdate['DIstatus']=='1'){ ?><i class="fa fa-lock"></i><? }?></span>
              </div>
            </div>
            <? } else { ?><input id="DIchoice" type="hidden" value=""><? } //End DigitalImages ?>
            <!--EngShoot-->
            <? if($row_rsUpdate['EngShoot']=='1'){ ?>
            <div class="row collapse">
              <div class="small-1 columns">
            ...
            <div class="row collapse">
              ...
              <div class="small-1 small-pull-1 columns">
                <span class="postfix radius"><?php if($row_rsUpdate['ESstatus']=='1'){ ?><i class="fa fa-lock"></i><? }?></span>
              </div>
            </div>
            <? } else { ?><input id="ESchoice" type="hidden" value=""><? } //End EngShoot ?>
            <!--PCredit-->
            <? if($row_rsUpdate['PCredit']=='1'){ ?>
            <div class="row collapse">
              <div class="small-1 columns">
            ...
            <div class="row collapse">
              ...
              <div class="small-1 small-pull-1 columns">
                <span class="postfix radius"><?php if($row_rsUpdate['PCstatus']=='1'){ ?><i class="fa fa-lock"></i><? }?></span>
              </div>
            </div>
            <div class="row collapse">
              <div class="small-6 small-offset-1 columns">
            ...
            <div class="row collapse">
              ...
              <div class="small-1 small-pull-1 columns">
                <span class="postfix radius"><?php if($row_rsUpdate['VFstatus']=='1'){ ?><i class="fa fa-lock"></i><? }?></span>
              </div>
            </div>
            <? } else { ?><input id="VFchoice" type="hidden" value=""><? } //End VideoFormat ?>
            <!--PreVideo-->
            <? if($row_rsUpdate['PreVideo']=='1'){ ?>
            <div class="row collapse">
              <div class="small-1 columns">
            ...
            <div class="row collapse">
              ...
              <div class="small-1 small-pull-1 columns">
                <span class="postfix radius"><?php if($row_rsUpdate['PVstatus']=='1'){ ?><i class="fa fa-lock"></i><? }?></span>
              </div>
            </div>
            <div class="row collapse">
              ...
              <div class="small-1 small-pull-1 columns">
                <span class="postfix radius"><?php if($row_rsUpdate['PVsongLock']=='1'){ ?><i class="fa fa-lock"></i><? }?></span>
              </div>
            </div>
            <div class="row collapse">
              <div class="small-3 small-offset-1 columns">
              ...
              <div class="small-1 small-pull-1 columns">
                <span class="postfix radius"><?php if($row_rsUpdate['PVcolorLock']=='1'){ ?><i class="fa fa-lock"></i><? }?></span>
              </div>
            </div>
            <? } //End PreVideo ?>     
            <!--MusicStyle-->
            <? if($row_rsUpdate['MusicStyle']=='1'){ ?>
            <div class="row collapse">
              <div class="small-1 columns">
            ...
            <div class="row collapse">
              ...
              <div class="small-1 small-pull-1 columns">
                <span class="postfix radius"><?php if($row_rsUpdate['MSstatus']=='1'){ ?><i class="fa fa-lock"></i><? }?></span>
              </div>
            </div>
            <? }//End MusicStyle ?>
            <!--Credits-->
            <? if($row_rsUpdate['Credits']=='1'){ ?>
            <div class="row collapse">
              <div class="small-1 columns">
            ...
            <div class="row collapse">
              ...
              <div class="small-1 small-pull-1 columns">
                <span class="postfix radius"><?php if($row_rsUpdate['CRstatus']=='1'){ ?><i class="fa fa-lock"></i><? }?></span>
              </div>
            </div>
            <div class="row collapse">
              <div class="small-3 small-offset-1 columns">
              ...
              <div class="small-1 small-pull-1 columns">
                <span class="postfix radius"><?php if($row_rsUpdate['CRsongLock']=='1'){ ?><i class="fa fa-lock"></i><? }?></span>
              </div>
            </div>
            <? } //End Credits ?> 
            <!--CoverDesign-->
            <? if($row_rsUpdate['CoverDesign']=='1'){ ?>
            <div class="row collapse">
              <div class="small-1 columns">
            ...
            <div class="row collapse">
              ...
              <div class="small-1 small-pull-1 columns">
                <span class="postfix radius"><?php if($row_rsUpdate['CDstatus']=='1'){ ?><i class="fa fa-lock"></i><? }?></span>
              </div>
            </div>
            <? } //End CoverDesign ?> 
          </div>
...
<a class="close-reveal-modal"><i class="fa fa-times-circle clrRed"></i></a>
  ...
  <div class="row">
    <div class="small-12 columns">
      <p class="tight"><? if($pkLevel=='Platinum' || $pkLevel=='Gold'){ ?> &nbsp; You can choose whether you would like to have the <?php echo $PVname; ?> finished before or after the event. However, the <strong>Before</strong> option must be selected at least 1 month before the event or <strong>After</strong> will be selected automatically.<br><? }?>
      ...
      &nbsp; <strong>Music</strong>: We will also need a couple of songs for the growing up portion (one song for each person), and one song for both as a couple.<? if($Format='Video'){echo' (Try not to pick a song you will also be using as a first dance or in your video credits too.)';}?><br>
...
<a class="close-reveal-modal"><i class="fa fa-times-circle clrRed"></i></a>
  ...
  <div class="row">
    <div class="small-12 columns">
      ...
      <? if($row_rsUpdate['CRchoice']=='Images'){ ?><br>
      &nbsp; We also incorporate photos and video that you provide (usually from the Honeymoon), to play along with the scrolling credits for an extra entertaining ending.<? }?></p>
...
<div id="alaCart-modal" class="reveal-modal medium" data-reveal>
  ...
  <div id="modal-list">
    <ul>
      <li>Ceremony Only (DIY) :: $<strong><? echo money_format('%i', $alaVid1);?></strong></li>
      <li>Ceremony Only (Edit) :: $<strong><? echo money_format('%i', $alaVid2);?></strong></li>
      <li>Ceremony & Hi-Lites (DIY) :: $<strong><? echo money_format('%i', $alaVid3);?></strong></li>
      <li>Ceremony & Hi-Lites (Edit) :: $<strong><? echo money_format('%i', $alaVid4);?></strong></li>           
    </ul>
  </div>
