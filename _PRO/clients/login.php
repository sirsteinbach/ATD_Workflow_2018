...
}?> <!DOCTYPE html><html lang="en" xml:lang="en" class="no-js"><head><meta charset="utf-8"><meta http-equiv="x-ua-compatible" content="ie=edge"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#22659C"><meta name="author" content="Stephen Steinbach"><meta name="webBuild" content="Foundation6.2.4"> <?php include_once($_SERVER["DOCUMENT_ROOT"]."/_php/googleAnalytics.php");?> <!--HOSTED--><script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery.min.js"></script><!--SELF--><link rel="stylesheet" href="../_css/F6.2.4/foundation.css"><link rel="stylesheet" href="../_css/F6.2.4/atd.css"><!--PAGE SPECIFIC--><title>Client Login</title><link rel="stylesheet" href="../_css/myCustom/inputs.css"></head><body><!--HEADSPACE--><div class="column row show-for-large space1em"></div><!--NAVBAR--> <?php require("../_php/navMain.php"); ?> <div class="row BgMain"><!--HEADSPACE--><div class="column row space4em"></div><div class="column show-for-large row space4em"></div></div><div class="row BgMain"><div class="small-11 small-centered medium-8 medium-centered large-6 large-centered columns"><section><div class="secHead <?php echo $status_bg;?>"><div class="iLine <?php echo $status_c;?>"><span class="fa-stack ilinePOS <?php echo $status_c;?>"><i class="fa fa-square fa-stack-2x"></i><i class="fa <?php echo $status_i;?> fa-stack-1x fa-inverse"></i></span><h1 class="c_333"><?php echo $status_m;?></h1></div></div><form action="<?php echo $loginFormAction; ?>" name="loginForm" id="loginForm" method="POST" data-abide novalidate><div class="column row space1em"></div><div class="row"><div class="small-11 small-centered columns"><!--ERROR--><div data-abide-error class="alert callout small" style="display:none;padding-left:1em;"><span class="fa-stack ilinePOS c_Red"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-exclamation-circle fa-stack-1x fa-inverse"></i></span><span>There are errors in your entry</span></div><!--USERNAME--><div class="input-group"><span class="input-group-addon"><i id="iUsername" class="fa fa-user fa-fw"></i></span> <input type="text" id="username" name="username" value="<?php echo $userName; ?>" placeholder="Accout Username" required pattern="[a-zA-Z\s.']+.{2,}"> <span class="input-group-error"><span class="input-group-cell"></span> <span class="input-group-cell"><small class="form-error">The account username is required</small></span></span></div><!--PASSWORD--><div class="input-group"><span class="input-group-addon"><i class="fa fa-lock fa-fw"></i></span> <input type="text" id="password" name="password" value="<?php echo $userPass; ?>" placeholder="Accout Password" required pattern="[a-zA-Z0-9\s.']+.{8,}"><div class="input-group-addon" style="white-space:nowrap;padding:0 1em;"><input type="checkbox" name="KeepMe" id="cbKeepMe" <?php echo $userKeep; ?> ><label for="cbKeepMe">Remember</label></div><span class="input-group-error"><span class="input-group-cell"></span> <span class="input-group-cell"><small class="form-error">The assigned password is required</small></span></span></div><div class="column row space1em"></div><div class="row"><div class="small-12 text-right columns"><button class="button success" type="submit" value="Submit">Submit</button> <button class="button warning" type="reset" value="Reset">Reset</button></div></div><div class="row Bglite"><!--HEADSPACE--><div class="column row space1em"></div></div></div></div></form></section></div></div><!--FLOORSPACE--><div class="row BgMain"><div class="column row space4em"></div><div class="column show-for-large row space4em"></div></div><!--FOOTER--> <?php require("../_php/footer.php"); ?> <!--FLOORSPACE--><div class="column row show-for-large space2em"></div><script src="../_js/F6.2.4/what-input.min.js"></script><script src="../_js/F6.2.4/foundation.min.js"></script><script>$(document).foundation();</script></body></html>