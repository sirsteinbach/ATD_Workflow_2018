...
<html lang="en" xml:lang="en" class="no-js">
  <head>
    ...
    <!-- Event snippet for Contact Form conversion page -->
		<script>gtag("event","conversion",{"send_to":"AW-990426188/Sx7VCIfpgnsQzOii2AM"});</script>
		<!--HOSTED-->	
	...
	<body>
		...
		<main class="row BgMain">
            ...
            <!--SEND RESPONSE-->
						...
						<div>
							<p>Thank you for contacting us about your upcoming event. We&rsquo;ll be contacting you shortly using the information you provided below.</p>
            ...
            <!--CONTACT FORM-->
						...
						<div>
							<p>Please tell us as much as possible to help us better respond to your inquiry. Don&rsquo;t worry, this information is only sent to us!</p>
						</div>
            ...
            <!--FORM-->
						<form id="contact" method="POST" action="contact.php" data-abide novalidate>
							...
							<!--?who=Bride&Name1=Susie%20Tester&Name2=Johnny%20Sample&Address=1234%20Main%20st.%20SE&City=Amazing&State=CA&Zip=98516&Phone=1234567890&Email=just@test.com&Date=12/25/2018&Location=Somewhere%20over%20the%20rainbow&Comment=This%20is%20only%20a%20test.%20Thank%20you%20for%20helping!-->
							...
							<div class="input-group">
								...
								<span class="input-group-cell"></span>
								<span class="input-group-cell">
								<small class="form-error">Choose a date or click &ldquo;Not Sure&rdquo;</small>
								</span>
								</span>
							</div>
							...
							<div class="input-group">
								...
								<select name="cf_respond" id="Respond" class="classic">
									...
									<option value="skype">Let&rsquo;s Chat on Skype</option>
							...
							<div class="text-right">
								<button type="Submit" class="small success button" name="Submit" id="Submit" value="Submit">Submit <i class="fa fa-share-square fa-fw"></i></button> <button type="reset" class="small warning button" id="reset" name="reset" value="reset">Reset <i class="fa fa-refresh fa-fw"></i></button>
							</div>
						</form>
						<?php } ?>
					</section>
					...
					<section id="Feedback">
						<header class="secHead bg_Teal">
							<div class="iLine c_Teal">
								<span class="fa-stack ilinePOS c_Teal"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-commenting fa-stack-1x fa-inverse"></i></span>
								<h3 class="c_333">Website FeedBack</h3>
							</div>
						</header>
            ...
            <!--GATHERED DATA-->
						<p>We hope you don&rsquo;t mind us gathering a bit of info to help us respond back with better information? This is only public informaiton we gathered from your browser.<br>
							<br>
							<small>
							<?php
		...
		<div class="reveal" id="mod-Skype" data-reveal>
			...
			<div class="column row">
				<div class="iLine c_DkGreen">
					<span class="fa-stack ilinePOS c_DkGreen"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-calendar-check-o fa-stack-1x fa-inverse"></i></span>
					<h3 class="c_333">Let&rsquo;s Set a Time?</h3>
				</div>
			</div>
			<div class="column row">
				<div class="callout success">
					<p>We don&rsquo;t leave our Skype open to everyone, but we&rsquo;d be happy to schedule a chat whenever you&rsquo;d like!</p>
					<p>Our Skype Name is &ldquo;<strong>AboutTheDay</strong>&rdquo;, and you are welcome to <strong>try</strong> connecting anytime... although, we&rsquo;d prefer a little advance notice so we can put on some makeup, fix our hair, and look presentable. :)</p>
				</div>
			</div>
			<div class="column row space1em"></div>
			<div class="column row">
				<div class="iLine c_Blue">
					<span class="fa-stack ilinePOS c_Blue"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-skype fa-stack-1x fa-inverse"></i></span>
					<h3 class="c_333">Want Us to Skype You?</h3>
				</div>
			</div>
			<div class="column row">
				<div class="callout secondary">
					<p>No problem. Just tell us when, and make sure we have your <strong>Skype Name</strong>, and we&rsquo;ll do our best to contact you when you ask.</p>
				</div>
			</div>
		...
		<div class="reveal" id="mod-Hangout" data-reveal>
			...
			<div class="column row">
				<div class="callout success">
					<p>We don&rsquo;t usually leave our Hangout open to everyone anymore, but we&rsquo;d be happy to schedule a chat whenever you&rsquo;d like!</p>
					<p>Our Hangout Name is &ldquo;<strong>AboutTheDay</strong>&rdquo;, and you are welcome to <strong>try</strong> connecting anytime you like... although, we&rsquo;d prefer a little advance notice so we can brush our teeth, comb our hair, and look presentable.</p>
				</div>
			</div>
			<div class="column row space1em"></div>
			<div class="column row">
				<div class="iLine c_Blue">
					<span class="fa-stack ilinePOS c_Blue"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-google-plus-square fa-stack-1x fa-inverse"></i></span>
					<h3 class="c_333">Want Us to Hangout You?</h3>
				</div>
			</div>
			<div class="column row">
				<div class="callout secondary">
					<p>No problem. Just tell us when, and make sure we have given us your <strong>Hangout Name</strong>, and we&rsquo;ll do our best to contact you when you ask.</p>
				</div>
			</div>
			<button class="close-button" data-close aria-label="Close modal" type="button">
			<span aria-hidden="true">&times;</span>
		...
		<div class="reveal small" id="mod-DNC" data-reveal>
			...
			<div class="column row">
				<div class="iLine c_Red">
					<span class="fa-stack ilinePOS c_Red"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-exclamation-triangle fa-stack-1x fa-inverse"></i></span>
					<h3 class="c_333">Are You Sure?</h3>
				</div>
			</div>
			<div class="column row">
				<div class="callout alert">
					<p>This often poses a real problem for us because email doesn&rsquo;t always get through! ** If you don"t recognize our email - or worse - it is sent to your junk mail, you&rsquo;ll think we never responded.</p>
				</div>
			</div>
			<div class="column row space1em"></div>
			<div class="column row">
				<div class="iLine c_DkOrange">
					<span class="fa-stack ilinePOS c_DkOrange"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-bell-slash fa-stack-1x fa-inverse"></i></span>
					<h3 class="c_333">Okay. . .</h3>
				</div>
			</div>
			<div class="column row">
		...
		<!--PAGE SPECIFIC-->
		<script src="../_js/specific/contact.js"></script>
