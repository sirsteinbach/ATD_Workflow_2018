...
<head>
	...
	<meta content="wedding photography photo canvas, image mounting, custom framing" name="keywords">
	<title>Wedding Photography Books &amp; Albums</title>
	<link href="../_css/specific/prodSlider.css" rel="stylesheet">
	<link href="../_css/specific/products.css" rel="stylesheet">
</head>
<body>
	<div class="column row show-for-large space1em"></div><!--NAVBAR-->
		...
		<div class="small-12 columns">
			<section>
				...
				<div class="row">
					...
					<div class="large-6 large-pull-6 medium-5 medium-pull-7 columns">
						<p>The Modern Album features a clean, contemporary look and feel that's beautiful to see and exciting to open.</p>
		...
		<div class="small-12 columns">
			<section>
				...
				<div class="row">
					...
					<div class="large-6 large-pull-6 medium-5 medium-pull-7 columns">
						<p>Keeping it simple doesn't mean you have to sacrifice class or quality. With a classic layout of one image on each page against a white background, the images really stand out, plus these albums feature customizable hard covers with colors to match almost any style or occasion... And at these prices, they make great keepsakes or thank you gifts as well.</p>
