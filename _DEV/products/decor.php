...
<html lang="en" xml:lang="en" class="no-js">
	<head>
		...
		<!--PAGE SPECIFIC-->
    <title>Canvas &amp; Decor :: About The Day Wedding Photography</title>
    ...
    <!--CONTENT-->
        ...
        <section>
					<header class="secHead bg_Canvas">
						<div class="iLine c_Canvas">
							<span class="fa-stack ilinePOS c_Canvas"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-picture-o fa-stack-1x fa-inverse"></i></span>
					...
					<div class="row">
						...
						<div class="large-6 large-pull-6 medium-5 medium-pull-7 columns">
							<p>Wildly popular and with good reason. It&rsquo;s hard to miss the striking beauty and dimension that a gorgeous canvas can add to a space. Your home suddenly because an Art Gallery!</p>
							<p>Every canvas is hand stretched on a custom built frame to ensure perfection, printed with ink rated to last 100 years, and spray sealed with a UV inhibitor coat that not only protects the color, but helps resist future fading and	strengthens it against damage.</p>
        ...
        <section>
					<header class="secHead bg_Mount">
						<div class="iLine c_Mount">
							<span class="fa-stack ilinePOS c_Mount"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-thumb-tack fa-stack-1x fa-inverse"></i></span>
					...
					<div class="row">
						...
						<div class="large-6 large-pull-6 medium-5 medium-pull-7 columns">
							<p>Transform your prints into something sophisticated and classy. Mounting a photograph has the same eye-popping beauty as our canvas options, but frees you from the distinctive look and feel of canvas. Clarity and Vibrancy go hand in hand!</p>
							<p>With our wide array of professional mounting options, you have huge selection of options, and can know that every print is mounted on the highest-quality substrate with Drytac&rsquo;s&reg; industry-leading Jetmount technology, ensuring our	best-in-class promise is behind every print.</p>
        ...
        <section>
					<header class="secHead bg_Frame">
						<div class="iLine c_Frame">
							<span class="fa-stack ilinePOS c_Frame"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-cube fa-stack-1x fa-inverse"></i></span>
					...
					<div class="row">
						...
						<div class="large-6 large-pull-6 medium-5 medium-pull-7 columns">
							...
							<p>Frames are solid wood with a contemporary, angular profile measuring 1.25&rdquo; wide x 0.75&rdquo; deep. A protective coating gives the frame rich color and a smooth finish. Shatterproof, scratch-resistant acrylic protects your print, while a solid backing provides a custom finish.</p>
    ...
    <script>
			$(function () {
			  $("#Canvas,#Mounting,#Frames").slippry({
