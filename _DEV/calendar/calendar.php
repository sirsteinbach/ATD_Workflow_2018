...
$thisPage="Calendar";$thisMenu="About";
  ...
  <main class="row BgMain">
    <div id="calContain" class="large-8 columns">
      <section class="pullup">
        <header class="secHead bg_Blue"><div class="iLine c_Blue"><span class="fa-stack ilinePOS c_Blue"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-calendar fa-stack-1x fa-inverse"></i></span><h1 class="c_333">Event Calendar</h1></div></header>
      </section>
      <div class="box">
      <div class="boxCenter">
    ...
    <div class="large-4 columns">
      <section>
        <header class="secHead bg_Red"><div class="iLine c_Red"><span class="fa-stack ilinePOS c_Red"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-lock fa-stack-1x fa-inverse"></i></span><h2 class="c_333">Confirmed Date</h2></div></header>
        ...
        <br>
        <header class="secHead noRadius bg_DkOrange"><div class="iLine c_DkOrange"><span class="fa-stack ilinePOS c_DkOrange"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-plane fa-stack-1x fa-inverse"></i></span><h2 class="c_333">Scheduled Travel</h2></div></header>
        ...
        <br>
        <header class="secHead noRadius bg_Blue"><div class="iLine c_Blue"><span class="fa-stack ilinePOS c_Blue"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-unlock fa-stack-1x fa-inverse"></i></span><h2 class="c_333">Other Dates</h2></div></header>
